...
from .models import ArtisteType, Show, Location, Locality, Type, ArtistTypeShow, Representation, Artist, RepresentationUser, User, Role, RoleUser, Revieuw
...
# Critiques des shows des users pour approbation #

class Reviews(ImportExportModelAdmin, admin.ModelAdmin):
    list_display=('id', 'user', 'show', 'comment', 'stars', 'created_at', 'updated_at', 'validate')
    list_edit = ('validate',)


# Approbation de l admin des critiques des shows par les users #

class ReviewAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'show', 'comment', 'stars', 'created_at', 'updated_at', 'approved')
    list_edit = ('approved',)
