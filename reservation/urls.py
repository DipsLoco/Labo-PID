...
urlpatterns = [
    ...
    path('shows/<int:show_id>/review', views.create_review, name='create_review'),

    path('artist', allArtists , name="allArtists"),   
    path('artist/<int:artist_id>',showArtist, name='showArtist'), 
    path('artist/create/', artistCreate, name='artistCreate'),  
    path('artist/<int:artist_id>/edit', editArtist , name='artist_edit'), 
